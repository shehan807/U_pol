...
for line in data:
    ...
    if "x =" in line:
        ...
        atomdata = line.split()
        atom_xyz.append(
            [atomdata[0], float(atomdata[3]), float(atomdata[6]), float(atomdata[9])]
        )
...
for i in range(len(atom_xyz)):
    ...
    print(
        "{0:3s}{1:16.6f}{2:16.6f}{3:16.6f}{4:7d}".format(
            atom_xyz[i][0],
            atom_xyz[i][1] * conv,
            atom_xyz[i][2] * conv,
            atom_xyz[i][3] * conv,
    ...
    # rank 1 block
    print(
        "{0:9.6f}\t{1:9.6f}\t{2:9.6f}".format(
            get_moment(multipole_moments[i], "Q10"),
            get_moment(multipole_moments[i], "Q11c"),
            get_moment(multipole_moments[i], "Q11s"),
        )
    )
    # rank 2 block
    print(
        "{0:9.6f}\t{1:9.6f}\t{2:9.6f}\t{3:9.6f}\t{4:9.6f}".format(
            get_moment(multipole_moments[i], "Q20"),
            get_moment(multipole_moments[i], "Q21c"),
            get_moment(multipole_moments[i], "Q21s"),
            get_moment(multipole_moments[i], "Q22c"),
            get_moment(multipole_moments[i], "Q22s"),
        )
    )
    # rank 3 block
    print(
        "{0:9.6f}\t{1:9.6f}\t{2:9.6f}\t{3:9.6f}\t{4:9.6f}\t{5:9.6f}\t{6:9.6f}".format(
            get_moment(multipole_moments[i], "Q30"),
            get_moment(multipole_moments[i], "Q31c"),
            get_moment(multipole_moments[i], "Q31s"),
            get_moment(multipole_moments[i], "Q32c"),
            get_moment(multipole_moments[i], "Q32s"),
            get_moment(multipole_moments[i], "Q33c"),
            get_moment(multipole_moments[i], "Q33s"),
        )
    )
    # rank 4 block
    print(
        "{0:9.6f}\t{1:9.6f}\t{2:9.6f}\t{3:9.6f}\t{4:9.6f}\t{5:9.6f}\t{6:9.6f}\t{7:9.6f}\t{8:9.6f}".format(
            get_moment(multipole_moments[i], "Q40"),
            get_moment(multipole_moments[i], "Q41c"),
            get_moment(multipole_moments[i], "Q41s"),
            get_moment(multipole_moments[i], "Q42c"),
            get_moment(multipole_moments[i], "Q42s"),
            get_moment(multipole_moments[i], "Q43c"),
            get_moment(multipole_moments[i], "Q43s"),
            get_moment(multipole_moments[i], "Q44c"),
            get_moment(multipole_moments[i], "Q44s"),
        )
    )
