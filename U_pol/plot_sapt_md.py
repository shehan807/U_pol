...
def plot_induction_parity(
    ...
    ax.tick_params(direction='in', length=6, width=border_width, which='major', top=True, right=True)
    ax.tick_params(direction='in', length=3, width=border_width, which='minor', top=True, right=True)
